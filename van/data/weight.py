...
STAGE_3_COMPONENTS = [
    ...
    {"item": "Alu-Cab 270° Shadow Awning RHS — passenger side",  "est_lbs": 53, "actual_lbs": None},
    {"item": "OVS HD Nomadic 180° awning LHS — driver side",     "est_lbs": 18, "actual_lbs": None},
    {"item": "Alu-Cab Shower Cube + LHS mounting brackets",      "est_lbs": 22, "actual_lbs": None},
    # Layout: 270 RHS = kitchen zone (rear + passenger side)
    #         180 LHS = shower zone overhead cover (driver side)
    #         Shower Cube stows LHS — balances 270 weight on RHS
    # Total: ~93 lbs vs original ~28 lbs (+65 lbs for full coverage + shower)
