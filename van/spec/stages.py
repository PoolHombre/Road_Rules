    ...
    3: {
        ...
        "items": {
            ...
            "Roof and Exterior": [
                ...
                "OVS HD Nomadic 180° awning — LHS (driver side)",
                "  · Covers driver side — primary role is overhead cover for Shower Cube",
                "  · Deployed with the 270° RHS: full rear + both sides covered",
                "  · Each awning deploys independently — use one or both as needed",
                "  · Mounts to front/mid section of Aluminess roof rack, driver side",
                "Alu-Cab Shower Cube — LHS (driver side, under 180° OVS awning)",
                "  · Dedicated shower/privacy zone on driver side — separate from kitchen",
                "  · Mounts to LHS roof rack brackets; stows on driver side rack",
                ...
                "  · Operational benefit: kitchen (RHS) and shower (LHS) operate simultaneously",
                "  · Weight distribution: Shower Cube on LHS balances 270° awning on RHS",
            ],
            "Refrigeration": [
